...
private:
    ...
    QFuture<QVector<double>> ftrProcessFile;
    QFuture<QVector<double>> ftrFindMax;
    QFuture<QVector<double>> ftrFindMin;

    QFutureWatcher<QVector<uint32_t>> ftrWtReadFile;
    QFutureWatcher<QVector<double>> ftrWtProcessFile;
    QFutureWatcher<QVector<double>> ftrWtFindMax;
    QFutureWatcher<QVector<double>> ftrWtFindMin;
